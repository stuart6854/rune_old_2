...
namespace rune::utility::primitives
{
    auto generate_plane(const glm::vec2& size = { 1.0f, 1.0f },
                        ...
                        const glm::uvec2& resolution = { 1, 1 }) -> std::unique_ptr<StaticMesh>;
    auto generate_cube(f32 size = 1.0f, const glm::vec3& offset = { 0.0f, 0.0f, 0.0f }) -> std::unique_ptr<StaticMesh>;
#if 0
