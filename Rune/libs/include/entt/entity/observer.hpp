...
namespace entt
{
        ...
        struct matcher_handler<matcher<type_list<Reject...>, type_list<Require...>, type_list<NoneOf...>, AllOf...>>
        {
            ...
            static void maybe_valid_if(basic_observer& obs, Registry& reg, const typename Registry::entity_type entt)
            {
                auto condition = [&reg, entt]()
                {
                    ...
                    {
                        return reg.template all_of<AllOf..., Require...>(entt) &&
                               ((std::is_same_v<Ignore..., NoneOf> || !reg.template any_of<NoneOf>(entt)) && ...) &&
                               !reg.template any_of<Reject...>(entt);
                    }
                };
    ...
    public:
        ...
        basic_observer() : basic_observer{ allocator_type{} } {}

        /**
         * @brief Constructs an empty storage with a given allocator.
         * @param allocator The allocator to use.
         */
        explicit basic_observer(const allocator_type& allocator) : base_type{ allocator }, release{} {}
         ...
         */
        [[nodiscard]] size_type size() const noexcept { return base_type::size(); }

        /**
         * @brief Checks whether an observer is empty.
         * @return True if the observer is empty, false otherwise.
         */
        [[nodiscard]] bool empty() const noexcept { return base_type::empty(); }
         ...
         */
        [[nodiscard]] const entity_type* data() const noexcept { return base_type::data(); }
         ...
         */
        [[nodiscard]] iterator begin() const noexcept { return base_type::base_type::begin(); }
         ...
         * observer.
         */
        [[nodiscard]] iterator end() const noexcept { return base_type::base_type::end(); }
