...
namespace entt
{
     ...
     */
    template <typename Type>
    struct is_meta_policy : std::bool_constant<std::is_same_v<Type, as_ref_t> || std::is_same_v<Type, as_cref_t> ||
                                               std::is_same_v<Type, as_is_t> || std::is_same_v<Type, as_void_t>>
    {
    };
