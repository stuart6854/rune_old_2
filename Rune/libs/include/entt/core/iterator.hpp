...
namespace entt
{
    ...
    struct input_iterator_pointer final
    {
         ...
         */
        [[nodiscard]] constexpr pointer operator->() noexcept { return std::addressof(value); }
    ...
    struct iterable_adaptor final
    {
        ...
        constexpr iterable_adaptor() noexcept(
            std::is_nothrow_default_constructible_v<iterator>&& std::is_nothrow_default_constructible_v<sentinel>)
            : first{}, last{}
        {
        }
