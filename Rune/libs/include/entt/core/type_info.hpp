...
namespace entt
{
    ...
    namespace internal
    {
        ...
        [[nodiscard]] static id_type type_hash(char) noexcept
        {
            ...
            { return hashed_string::value(stripped.data(), stripped.size()); }(stripped_type_name<Type>());
            return value;
        }
    ...
    struct type_name final
    {
         ...
         */
        [[nodiscard]] static constexpr std::string_view value() noexcept { return internal::type_name<Type>(0); }
