...
MonoMethodBuilder* mono_mb_new_no_dup_name(MonoClass* klass, const char* name, MonoWrapperType type);
...
void mono_install_method_builder_callbacks(MonoMethodBuilderCallbacks* cb);
