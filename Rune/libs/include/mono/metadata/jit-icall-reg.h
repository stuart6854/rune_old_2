...
MONO_LLVM_INTERNAL MonoJitICallInfos* mono_get_jit_icall_info(void);
...
//
static inline MonoJitICallInfo* mono_find_jit_icall_info(MonoJitICallId id)
{
...
inline MonoJitICallInfo* mono_find_jit_icall_info(gsize id)
{
