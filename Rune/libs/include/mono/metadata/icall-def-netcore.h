...
HANDLES(RASSEM_5,
        ...
        (MonoReflectionAssembly))
HANDLES(
    RASSEM_6, "GetModulesInternal", ves_icall_System_Reflection_RuntimeAssembly_GetModulesInternal, MonoArray, 1, (MonoReflectionAssembly))
HANDLES(RASSEM_6b,
        "GetTopLevelForwardedTypes",
...
HANDLES(NATIVEL_2,
        ...
        gpointer,
        3,
        (gpointer, MonoString, MonoBoolean))
HANDLES(NATIVEL_3,
        "LoadByName",
...
HANDLES(
    NATIVEL_4, "LoadFromPath", ves_icall_System_Runtime_InteropServices_NativeLibrary_LoadFromPath, gpointer, 2, (MonoString, MonoBoolean))
...
HANDLES(ALC_5,
        ...
        (MonoReflectionAssembly))
HANDLES(
    ALC_4, "InternalGetLoadedAssemblies", ves_icall_System_Runtime_Loader_AssemblyLoadContext_InternalGetLoadedAssemblies, MonoArray, 0, ())
HANDLES(ALC_2,
        "InternalInitializeNativeALC",
        ves_icall_System_Runtime_Loader_AssemblyLoadContext_InternalInitializeNativeALC,
        gpointer,
        3,
        (gpointer, MonoBoolean, MonoBoolean))
HANDLES(ALC_1,
        "InternalLoadFile",
...
HANDLES(ALC_3,
        ...
        MonoReflectionAssembly,
        5,
        (gpointer, gpointer, gint32, gpointer, gint32))
...
HANDLES(MONIT_9,
        ...
        void,
        4,
        (MonoObject, guint32, MonoBoolean, MonoBoolean_ref))
...
HANDLES(
    THREAD_8, "SetName_icall", ves_icall_System_Threading_Thread_SetName_icall, void, 3, (MonoInternalThread, const_gunichar2_ptr, gint32))
