...
MONO_API MONO_RT_EXTERNAL_ONLY MonoAssembly* mono_assembly_open(const char* filename, MonoImageOpenStatus* status);
MONO_API MONO_RT_EXTERNAL_ONLY MonoAssembly* mono_assembly_open_full(const char* filename, MonoImageOpenStatus* status, mono_bool refonly);
MONO_API MONO_RT_EXTERNAL_ONLY MonoAssembly* mono_assembly_load(MonoAssemblyName* aname, const char* basedir, MonoImageOpenStatus* status);
MONO_API MONO_RT_EXTERNAL_ONLY MonoAssembly* mono_assembly_load_full(MonoAssemblyName* aname,
                                                                     const char* basedir,
                                                                     MonoImageOpenStatus* status,
                                                                     mono_bool refonly);
MONO_API MONO_RT_EXTERNAL_ONLY MonoAssembly* mono_assembly_load_from(MonoImage* image, const char* fname, MonoImageOpenStatus* status);
MONO_API MONO_RT_EXTERNAL_ONLY MonoAssembly* mono_assembly_load_from_full(MonoImage* image,
                                                                          const char* fname,
                                                                          MonoImageOpenStatus* status,
                                                                          mono_bool refonly);

MONO_API MONO_RT_EXTERNAL_ONLY MonoAssembly* mono_assembly_load_with_partial_name(const char* name, MonoImageOpenStatus* status);

MONO_API MONO_RT_EXTERNAL_ONLY MonoAssembly* mono_assembly_loaded(MonoAssemblyName* aname);
MONO_API MONO_RT_EXTERNAL_ONLY MonoAssembly* mono_assembly_loaded_full(MonoAssemblyName* aname, mono_bool refonly);
...
MONO_API MONO_RT_EXTERNAL_ONLY MonoAssemblyName* mono_assembly_get_name(MonoAssembly* assembly);
...
MONO_API MONO_RT_EXTERNAL_ONLY void mono_install_assembly_load_hook(MonoAssemblyLoadFunc func, void* user_data);
...
MONO_API MONO_RT_EXTERNAL_ONLY void mono_install_assembly_search_hook(MonoAssemblySearchFunc func, void* user_data);
MONO_API MONO_RT_EXTERNAL_ONLY void mono_install_assembly_refonly_search_hook(MonoAssemblySearchFunc func, void* user_data);

MONO_API MONO_RT_EXTERNAL_ONLY MonoAssembly* mono_assembly_invoke_search_hook(MonoAssemblyName* aname);
 ...
 */
MONO_API MONO_RT_EXTERNAL_ONLY void mono_install_assembly_postload_search_hook(MonoAssemblySearchFunc func, void* user_data);

MONO_API MONO_RT_EXTERNAL_ONLY void mono_install_assembly_postload_refonly_search_hook(MonoAssemblySearchFunc func, void* user_data);
...
MONO_API MONO_RT_EXTERNAL_ONLY void mono_install_assembly_preload_hook(MonoAssemblyPreLoadFunc func, void* user_data);
MONO_API MONO_RT_EXTERNAL_ONLY void mono_install_assembly_refonly_preload_hook(MonoAssemblyPreLoadFunc func, void* user_data);

MONO_API MONO_RT_EXTERNAL_ONLY void mono_assembly_invoke_load_hook(MonoAssembly* ass);
...
MONO_API uint16_t mono_assembly_name_get_version(MonoAssemblyName* aname, uint16_t* minor, uint16_t* build, uint16_t* revision);
