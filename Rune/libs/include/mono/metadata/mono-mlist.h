...
MONO_API MONO_RT_EXTERNAL_ONLY MonoMList* mono_mlist_alloc(MonoObject* data);
...
MONO_API MONO_RT_EXTERNAL_ONLY MonoMList* mono_mlist_prepend(MonoMList* list, MonoObject* data);
MONO_API MONO_RT_EXTERNAL_ONLY MonoMList* mono_mlist_append(MonoMList* list, MonoObject* data);
