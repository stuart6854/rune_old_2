...
ICALL_EXPORT MonoBoolean ves_icall_System_Reflection_AssemblyName_ParseAssemblyName(const char*,
                                                                                    MonoAssemblyName*,
                                                                                    MonoBoolean*,
                                                                                    MonoBoolean* is_token_defined_arg);
...
#endif
ICALL_EXPORT void ves_icall_System_NumberFormatter_GetFormatterTables(
    guint64 const**, gint32 const**, gunichar2 const**, gunichar2 const**, gint64 const**, gint32 const**);
#if ENABLE_NETCORE
...
ICALL_EXPORT gpointer ves_icall_System_IO_Compression_DeflateStreamNative_CreateZStream(gint32 compress,
                                                                                        MonoBoolean gzip,
                                                                                        gpointer feeder,
                                                                                        gpointer data);
...
ICALL_EXPORT gint32 ves_icall_System_Net_NetworkInformation_LinuxNetworkChange_ReadEvents(gpointer sock,
                                                                                          gpointer buffer,
                                                                                          gint32 count,
                                                                                          gint32 size);
...
ICALL_EXPORT MonoBoolean ves_icall_Microsoft_Win32_NativeMethods_GetProcessTimes(
    gpointer handle, gint64* creation_time, gint64* exit_time, gint64* kernel_time, gint64* user_time);
...
ICALL_EXPORT void ves_icall_System_Array_InternalCreate(
    MonoArray* volatile* result, MonoType* type, gint32 rank, gint32* pLengths, gint32* pLowerBounds);
ICALL_EXPORT MonoBoolean ves_icall_System_Array_CanChangePrimitive(MonoReflectionType* volatile* ref_src_type_handle,
                                                                   MonoReflectionType* volatile* ref_dst_type_handle,
                                                                   MonoBoolean reliable);
...
ICALL_EXPORT MonoBoolean ves_icall_System_Net_Sockets_Socket_Duplicate_icall(gpointer handle,
                                                                             gint32 targetProcessId,
                                                                             gpointer* duplicate_handle,
                                                                             gint32* werror);
...
ICALL_EXPORT gint32 ves_icall_System_Net_Sockets_Socket_Receive_icall(
    gsize sock, gchar* buffer, gint32 count, gint32 flags, gint32* werror, MonoBoolean blocking);
ICALL_EXPORT gint32 ves_icall_System_Net_Sockets_Socket_Receive_array_icall(
    gsize sock, WSABUF* buffers, gint32 count, gint32 flags, gint32* werror, MonoBoolean blocking);
ICALL_EXPORT gint32
...
ICALL_EXPORT gint32 ves_icall_System_Net_Sockets_Socket_Send_array_icall(
    gsize sock, WSABUF* buffers, gint32 count, gint32 flags, gint32* werror, MonoBoolean blocking);
...
ICALL_EXPORT gpointer ves_icall_System_Threading_Semaphore_CreateSemaphore_icall(
    gint32 initialCount, gint32 maximumCount, const gunichar2* name, gint32 name_length, gint32* win32error);
ICALL_EXPORT gpointer ves_icall_System_Threading_Semaphore_OpenSemaphore_icall(const gunichar2* name,
                                                                               gint32 name_length,
                                                                               gint32 rights,
                                                                               gint32* win32error);
ICALL_EXPORT MonoBoolean ves_icall_System_Threading_Semaphore_ReleaseSemaphore_internal(gpointer handle,
                                                                                        gint32 releaseCount,
                                                                                        gint32* prevcount);
