...
//
// you should write:
// 	HANDLES(ID_n, "your_internal_call", "ves_icall_your_internal_call", MonoObject, 7, (gint32, MonoObject, gint32_ref, gpointer,
// MyStruct_ref, MyClassInOut, MonoStringOut))
//
...
// 	MonoRawHandle* ves_icall_your_internal_call_raw (gint32, MonoRawHandle*, gint32*, gpointer, MyStruct*, MonoRawHandle*,
// MonoRawHandle*);
//
// whose body will be generated by the HANDLES() macro, and which will call the following function that you have to implement:
// 	MonoObjectHandle ves_icall_your_internal_call (gint32, MonoObjectHandle, gint32*, gpointer, MyStruct*, MyClassHandleInOut,
// MonoStringOut, MonoError *error);
//
...
HANDLES(RUNTIME_2,
        "EnableMicrosoftTelemetry_internal",
        ves_icall_Mono_Runtime_EnableMicrosoftTelemetry,
        void,
        6,
        (const_char_ptr, const_char_ptr, const_char_ptr, const_char_ptr, const_char_ptr, const_char_ptr))
HANDLES(RUNTIME_3,
        "ExceptionToState_internal",
        ves_icall_Mono_Runtime_ExceptionToState,
        MonoString,
        3,
...
HANDLES(RUNTIME_13,
        "SendMicrosoftTelemetry_internal",
        ves_icall_Mono_Runtime_SendMicrosoftTelemetry,
        void,
        3,
...
HANDLES(
    APPDOM_1, "ExecuteAssembly", ves_icall_System_AppDomain_ExecuteAssembly, gint32, 3, (MonoAppDomain, MonoReflectionAssembly, MonoArray))
...
HANDLES(APPDOM_15,
        ...
        5,
        (MonoAppDomain, MonoString, MonoObject, MonoBoolean, MonoStackCrawlMark_ptr))
HANDLES(APPDOM_16,
        "LoadAssemblyRaw",
        ves_icall_System_AppDomain_LoadAssemblyRaw,
        MonoReflectionAssembly,
        5,
        (MonoAppDomain, MonoArray, MonoArray, MonoObject, MonoBoolean))
...
HANDLES(BUFFER_1,
        "InternalBlockCopy",
        ves_icall_System_Buffer_BlockCopyInternal,
        MonoBoolean,
        5,
        (MonoArray, gint32, MonoArray, gint32, gint32))
...
HANDLES(
    CLRCONFIG_1, "CheckThrowUnobservedTaskExceptions", ves_icall_System_CLRConfig_CheckThrowUnobservedTaskExceptions, MonoBoolean, 0, ())

ICALL_TYPE(DEFAULTC, "System.Configuration.DefaultConfig", DEFAULTC_1)
HANDLES(
    DEFAULTC_1, "get_bundled_machine_config", ves_icall_System_Configuration_DefaultConfig_get_bundled_machine_config, MonoString, 0, ())
...
HANDLES(INTCFGHOST_1,
        "get_bundled_app_config",
        ves_icall_System_Configuration_InternalConfigurationHost_get_bundled_app_config,
        MonoString,
        0,
        ())
HANDLES(INTCFGHOST_2,
...
HANDLES(
    DELEGATE_3, "GetVirtualMethod_internal", ves_icall_System_Delegate_GetVirtualMethod_internal, MonoReflectionMethod, 1, (MonoDelegate))
...
HANDLES(FILEV_1,
        ...
        void,
        3,
        (MonoObject, const_gunichar2_ptr, int))
...
HANDLES(PERFCTRCAT_3,
        "CounterCategoryExists_icall",
        mono_perfcounter_category_exists,
        MonoBoolean,
        4,
        (const_gunichar2_ptr, gint32, const_gunichar2_ptr, gint32))
HANDLES(PERFCTRCAT_4,
        "Create_icall",
        mono_perfcounter_create,
        MonoBoolean,
        6,
        (const_gunichar2_ptr, gint32, const_gunichar2_ptr, gint32, gint32, MonoArray))
...
HANDLES(PERFCTRCAT_8,
        "InstanceExistsInternal_icall",
...
HANDLES(PROCESS_1,
        ...
        MonoBoolean,
        5,
        (MonoW32ProcessStartInfo, gpointer, gpointer, gpointer, MonoW32ProcessInfo_ref))
...
HANDLES(PROCESS_13,
        ...
        MonoBoolean,
        2,
        (MonoW32ProcessStartInfo, MonoW32ProcessInfo_ref))
...
HANDLES_REUSE_WRAPPER(
    ENV_5, "GetMachineConfigPath", ves_icall_System_Configuration_DefaultConfig_get_machine_config_path, MonoString, 0, ())
...
HANDLES(CALDATA_1,
        ...
        MonoBoolean,
        3,
        (MonoCalendarData, MonoString, gint32))
...
HANDLES(MMAPIMPL_5,
        ...
        gpointer,
        9,
        (const_gunichar2_ptr, int, int, const_gunichar2_ptr, int, gint64_ref, int, int, int_ref))
HANDLES(MMAPIMPL_6,
        "OpenHandleInternal",
        mono_mmap_open_handle,
        gpointer,
        7,
        (gpointer, const_gunichar2_ptr, int, gint64_ref, int, int, int_ref))
...
HANDLES(MONOIO_35a,
        ...
        gpointer,
        4,
        (const_gunichar2_ptr, MonoStringOut, gint32_ref, gint32_ref))
HANDLES(
    MONOIO_36a, "FindNextFile", ves_icall_System_IO_MonoIO_FindNextFile, MonoBoolean, 4, (gpointer, MonoStringOut, gint32_ref, gint32_ref))
NOHANDLES(ICALL(MONOIO_6, "Flush(intptr,System.IO.MonoIOError&)", ves_icall_System_IO_MonoIO_Flush))
HANDLES(
    MONOIO_7, "GetCurrentDirectory(System.IO.MonoIOError&)", ves_icall_System_IO_MonoIO_GetCurrentDirectory, MonoString, 1, (gint32_ref))
...
NOHANDLES(ICALL(MONOIO_15, "MoveFile(char*,char*,System.IO.MonoIOError&)", ves_icall_System_IO_MonoIO_MoveFile))
    #endif /* !PLATFORM_RO_FS */
NOHANDLES(ICALL(MONOIO_16,
                "Open(char*,System.IO.FileMode,System.IO.FileAccess,System.IO.FileShare,System.IO.FileOptions,System.IO.MonoIOError&)",
...
HANDLES(MONOIO_17,
        ...
        gint32,
        5,
        (gpointer, MonoArray, gint32, gint32, gint32_ref))
    #ifndef PLATFORM_RO_FS
...
NOHANDLES(ICALL(MONOIO_21,
                "SetFileAttributes(char*,System.IO.FileAttributes,System.IO.MonoIOError&)",
                ves_icall_System_IO_MonoIO_SetFileAttributes))
...
HANDLES(MONOIO_25,
        ...
        ves_icall_System_IO_MonoIO_Write,
        gint32,
        5,
        (gpointer, MonoArray, gint32, gint32, gint32_ref))
...
HANDLES(NDNS_1,
        "GetHostByAddr_icall",
        ves_icall_System_Net_Dns_GetHostByAddr,
        MonoBoolean,
        5,
        (MonoString, MonoStringOut, MonoArrayOut, MonoArrayOut, gint32))
HANDLES(NDNS_2,
        "GetHostByName_icall",
...
HANDLES(MAC_IFACE_PROPS_1,
        "ParseRouteInfo_icall",
        ves_icall_System_Net_NetworkInformation_MacOsIPInterfaceProperties_ParseRouteInfo,
        MonoBoolean,
        2,
        (MonoString, MonoArrayOut))
...
HANDLES(SOCK_7,
        "GetSocketOption_arr_icall",
        ves_icall_System_Net_Sockets_Socket_GetSocketOption_arr_icall,
        void,
        5,
        (gsize, gint32, gint32, MonoArray, gint32_ref))
HANDLES(SOCK_8,
        "GetSocketOption_obj_icall",
        ves_icall_System_Net_Sockets_Socket_GetSocketOption_obj_icall,
        void,
        5,
        (gsize, gint32, gint32, MonoObjectOut, gint32_ref))
HANDLES(SOCK_21,
        "IOControl_icall",
        ves_icall_System_Net_Sockets_Socket_IOControl_icall,
        int,
        5,
        (gsize, gint32, MonoArray, MonoArray, gint32_ref))
...
HANDLES(SOCK_13,
        "ReceiveFrom_icall",
        ves_icall_System_Net_Sockets_Socket_ReceiveFrom_icall,
        gint32,
        7,
        (gsize, char_ptr, gint32, gint32, MonoObjectInOut, gint32_ref, MonoBoolean))
...
HANDLES(
    SOCK_14, "RemoteEndPoint_icall", ves_icall_System_Net_Sockets_Socket_RemoteEndPoint_icall, MonoObject, 3, (gsize, gint32, gint32_ref))
HANDLES(SOCK_15, "Select_icall", ves_icall_System_Net_Sockets_Socket_Select_icall, void, 3, (MonoArrayInOut, gint32, gint32_ref))
HANDLES(SOCK_15a,
        "SendFile_icall",
        ves_icall_System_Net_Sockets_Socket_SendFile_icall,
        MonoBoolean,
        7,
        (gsize, MonoString, MonoArray, MonoArray, int, gint32_ref, MonoBoolean))
HANDLES(SOCK_16,
        "SendTo_icall",
        ves_icall_System_Net_Sockets_Socket_SendTo_icall,
        gint32,
        7,
        (gsize, char_ptr, gint32, gint32, MonoObject, gint32_ref, MonoBoolean))
...
HANDLES(SOCK_18,
        ...
        ves_icall_System_Net_Sockets_Socket_SetSocketOption_icall,
        void,
        7,
        (gsize, gint32, gint32, MonoObject, MonoArray, gint32, gint32_ref))
...
HANDLES(ASSEM_12,
        "InternalGetReferencedAssemblies",
...
HANDLES(ASSEM_15,
        ...
        MonoReflectionType,
        5,
        (MonoReflectionAssembly, MonoReflectionModule, MonoString, MonoBoolean, MonoBoolean))
HANDLES(ASSEM_16a,
        "LoadFile_internal",
        ves_icall_System_Reflection_Assembly_LoadFile_internal,
        MonoReflectionAssembly,
        2,
        (MonoString, MonoStackCrawlMark_ptr))
HANDLES(ASSEM_17,
        "LoadFrom",
        ves_icall_System_Reflection_Assembly_LoadFrom,
        MonoReflectionAssembly,
        3,
        (MonoString, MonoBoolean, MonoStackCrawlMark_ptr))
HANDLES(ASSEM_26,
        "load_with_partial_name",
        ves_icall_System_Reflection_Assembly_load_with_partial_name,
        MonoReflectionAssembly,
        2,
        (MonoString, MonoObject))
...
HANDLES(CATTR_DATA_1,
        "ResolveArgumentsInternal",
        ves_icall_System_Reflection_CustomAttributeData_ResolveArgumentsInternal,
        void,
        6,
        (MonoReflectionMethod, MonoReflectionAssembly, gpointer, guint32, MonoArrayOut, MonoArrayOut))

ICALL_TYPE(ASSEMB, "System.Reflection.Emit.AssemblyBuilder", ASSEMB_1)
HANDLES(ASSEMB_1,
        "UpdateNativeCustomAttributes",
        ves_icall_AssemblyBuilder_UpdateNativeCustomAttributes,
        void,
        1,
...
HANDLES(CATTRB_1,
        "GetBlob",
        ves_icall_CustomAttributeBuilder_GetBlob,
        MonoArray,
        7,
        (MonoReflectionAssembly, MonoObject, MonoArray, MonoArray, MonoArray, MonoArray, MonoArray))
    #endif
...
HANDLES(
    MODULEB_9, "set_wrappers_type", ves_icall_ModuleBuilder_set_wrappers_type, void, 2, (MonoReflectionModuleBuilder, MonoReflectionType))
...
HANDLES(FILEDI_2,
        ...
        MonoReflectionField,
        2,
        (MonoClassField_ref, MonoType_ref))
...
HANDLES(MMETHI_2,
        ...
        MonoArray,
        2,
        (MonoMethod_ptr, MonoReflectionMethod))
HANDLES(MMETHI_3,
        "get_retval_marshal",
...
HANDLES(RASSEM_2,
        ...
        MonoObject,
        3,
        (MonoReflectionAssembly, MonoString, MonoBoolean))
HANDLES(RASSEM_3,
...
HANDLES(RASSEM_5,
        ...
        gpointer,
        4,
        (MonoReflectionAssembly, MonoString, gint32_ref, MonoReflectionModuleOut))
HANDLES(RASSEM_6,
        ...
        (MonoReflectionAssembly))
HANDLES(
    RASSEM_7, "GetModulesInternal", ves_icall_System_Reflection_RuntimeAssembly_GetModulesInternal, MonoArray, 1, (MonoReflectionAssembly))
HANDLES(RASSEM_8,
...
HANDLES(RASSEM_9,
        "LoadPermissions",
        ves_icall_System_Reflection_RuntimeAssembly_LoadPermissions,
        MonoBoolean,
        7,
        (MonoReflectionAssembly, char_ptr_ref, guint32_ref, char_ptr_ref, guint32_ref, char_ptr_ref, guint32_ref))
HANDLES(RASSEM_10,
        "get_EntryPoint",
...
HANDLES(RASSEM_11,
        "get_ReflectionOnly",
        ves_icall_System_Reflection_RuntimeAssembly_get_ReflectionOnly,
        MonoBoolean,
        1,
        (MonoReflectionAssembly))
HANDLES(RASSEM_12,
        "get_code_base",
        ves_icall_System_Reflection_RuntimeAssembly_get_code_base,
        MonoString,
        2,
        (MonoReflectionAssembly, MonoBoolean))
...
HANDLES(RASSEM_14,
        ...
        ves_icall_System_Reflection_RuntimeAssembly_get_global_assembly_cache,
        MonoBoolean,
        1,
        (MonoReflectionAssembly))
...
HANDLES(MCMETH_1,
        ...
        (MonoReflectionMethod))
HANDLES(
    MCMETH_2, "InternalInvoke", ves_icall_InternalInvoke, MonoObject, 4, (MonoReflectionMethod, MonoObject, MonoArray, MonoExceptionOut))
...
HANDLES(
    MFIELD_4, "GetTypeModifiers", ves_icall_System_Reflection_FieldInfo_GetTypeModifiers, MonoArray, 2, (MonoReflectionField, MonoBoolean))
...
HANDLES(RMETHODINFO_9,
        "get_IsGenericMethodDefinition",
        ves_icall_RuntimeMethodInfo_get_IsGenericMethodDefinition,
        MonoBoolean,
        1,
        (MonoReflectionMethod))
HANDLES(RMETHODINFO_10,
        "get_base_method",
...
HANDLES(MODULE_7,
        ...
        MonoClassField_ptr,
        5,
        (MonoImage_ptr, guint32, MonoArray, MonoArray, MonoResolveTokenError_ref))
HANDLES(MODULE_8,
        "ResolveMemberToken",
...
HANDLES(MODULE_10,
        "ResolveSignature",
        ves_icall_System_Reflection_RuntimeModule_ResolveSignature,
        MonoArray,
        3,
        (MonoImage_ptr, guint32, MonoResolveTokenError_ref))
HANDLES(MODULE_11,
        "ResolveStringToken",
...
HANDLES(MPARAMI_2,
        "GetTypeModifiers",
        ves_icall_RuntimeParameterInfo_GetTypeModifiers,
        MonoArray,
        4,
...
HANDLES(MPROP_4,
        "get_property_info",
        ves_icall_RuntimePropertyInfo_get_property_info,
        void,
        3,
...
HANDLES(RUNH_3,
        ...
        void,
        2,
        (MonoArray, MonoClassField_ptr))
HANDLES(
    RUNH_4, "RunClassConstructor", ves_icall_System_Runtime_CompilerServices_RuntimeHelpers_RunClassConstructor, void, 1, (MonoType_ptr))
HANDLES(
    RUNH_5, "RunModuleConstructor", ves_icall_System_Runtime_CompilerServices_RuntimeHelpers_RunModuleConstructor, void, 1, (MonoImage_ptr))
...
HANDLES(MARSHAL_4,
        "DestroyStructure",
        ves_icall_System_Runtime_InteropServices_Marshal_DestroyStructure,
        void,
        2,
        (gpointer, MonoReflectionType))
...
HANDLES(MARSHAL_8,
        ...
        ves_icall_System_Runtime_InteropServices_Marshal_GetComSlotForMethodInfoInternal,
        guint32,
        1,
        (MonoReflectionMethod))
    #endif
...
HANDLES(MARSHAL_10,
    ...
    #ifndef DISABLE_COM
HANDLES(MARSHAL_52,
        "GetHRForException_WinRT",
        ves_icall_System_Runtime_InteropServices_Marshal_GetHRForException_WinRT,
        int,
        1,
        (MonoException))
HANDLES(MARSHAL_45,
...
HANDLES(MARSHAL_54,
        "GetRawIUnknownForComObjectNoAddRef",
...
HANDLES(MARSHAL_48, "IsComObject", ves_icall_System_Runtime_InteropServices_Marshal_IsComObject, MonoBoolean, 1, (MonoObject))
    #endif
HANDLES(
    MARSHAL_48a, "IsPinnableType", ves_icall_System_Runtime_InteropServices_Marshal_IsPinnableType, MonoBoolean, 1, (MonoReflectionType))
...
HANDLES(MARSHAL_49,
        ...
        ves_icall_System_Runtime_InteropServices_Marshal_ReleaseComObjectInternal,
        gint32,
        1,
        (MonoObject))
    #endif
...
HANDLES(MARSHAL_31,
        "SizeOfHelper",
        ves_icall_System_Runtime_InteropServices_Marshal_SizeOfHelper,
        guint32,
        2,
...
HANDLES(MARSHAL_34,
        ...
        void,
        3,
        (MonoObject, gpointer, MonoBoolean))
HANDLES(MARSHAL_35,
...
HANDLES(MARSHAL_41,
        ...
        void,
        5,
        (gconstpointer, gint32, MonoArray, gint32, gpointer))
HANDLES(MARSHAL_42,
        "copy_to_unmanaged_fixed",
        ves_icall_System_Runtime_InteropServices_Marshal_copy_to_unmanaged,
        void,
        5,
        (MonoArray, gint32, gpointer, gint32, gconstpointer))
...
HANDLES(WINDOWSRUNTIME_UNM_0,
        "GetRestrictedErrorInfo",
        ves_icall_System_Runtime_InteropServices_WindowsRuntime_UnsafeNativeMethods_GetRestrictedErrorInfo,
        MonoObject,
        0,
        ())
HANDLES(WINDOWSRUNTIME_UNM_1,
        "RoOriginateLanguageException",
        ves_icall_System_Runtime_InteropServices_WindowsRuntime_UnsafeNativeMethods_RoOriginateLanguageException,
        MonoBoolean,
        3,
        (int, MonoString, gpointer))
HANDLES(WINDOWSRUNTIME_UNM_2,
        "RoReportUnhandledError",
        ves_icall_System_Runtime_InteropServices_WindowsRuntime_UnsafeNativeMethods_RoReportUnhandledError,
        void,
        1,
        (MonoObject))
HANDLES(WINDOWSRUNTIME_UNM_3,
        "WindowsCreateString",
        ves_icall_System_Runtime_InteropServices_WindowsRuntime_UnsafeNativeMethods_WindowsCreateString,
        int,
        3,
        (MonoString, int, gpointer_ptr))
HANDLES(WINDOWSRUNTIME_UNM_4,
        "WindowsDeleteString",
        ves_icall_System_Runtime_InteropServices_WindowsRuntime_UnsafeNativeMethods_WindowsDeleteString,
        int,
        1,
        (gpointer))
HANDLES(WINDOWSRUNTIME_UNM_5,
        "WindowsGetStringRawBuffer",
        ves_icall_System_Runtime_InteropServices_WindowsRuntime_UnsafeNativeMethods_WindowsGetStringRawBuffer,
        mono_unichar2_ptr,
        2,
        (gpointer, unsigned_ptr))
    #endif
...
HANDLES(REMSER_0,
        ...
        MonoReflectionMethod,
        2,
        (MonoReflectionType, MonoReflectionMethod))
...
HANDLES(RFH_1,
        ...
        MonoObject,
        4,
        (MonoReflectionField, MonoReflectionType, MonoTypedRef_ptr, MonoReflectionType))
HANDLES(RFH_1a,
        "SetValueDirect",
        ves_icall_System_RuntimeFieldHandle_SetValueDirect,
        void,
        5,
        (MonoReflectionField, MonoReflectionType, MonoTypedRef_ptr, MonoObject, MonoReflectionType))
...
HANDLES(
    RT_5, "GetFields_native", ves_icall_RuntimeType_GetFields_native, GPtrArray_ptr, 4, (MonoReflectionType, char_ptr, guint32, guint32))
...
HANDLES(RT_13,
        ...
        ves_icall_RuntimeType_GetNestedTypes_native,
        GPtrArray_ptr,
        4,
...
HANDLES(RTH_17a,
        ...
        MonoReflectionType,
        6,
        (MonoString, MonoStackCrawlMark_ptr, MonoReflectionAssembly, MonoBoolean, MonoBoolean, MonoBoolean))
...
HANDLES(WINIMP_4,
        "SetCurrentToken",
        ves_icall_System_Security_Principal_WindowsImpersonationContext_SetCurrentToken,
        MonoBoolean,
        1,
        (gpointer))
...
HANDLES(UNORM_1,
        ...
        void,
        6,
        (guint8_ptr_ref, guint8_ptr_ref, guint8_ptr_ref, guint8_ptr_ref, guint8_ptr_ref, guint8_ptr_ref))
...
HANDLES(MONIT_9,
        ...
        void,
        3,
        (MonoObject, guint32, MonoBoolean_ref))

ICALL_TYPE(MUTEX, "System.Threading.Mutex", MUTEX_1)
HANDLES(MUTEX_1,
        "CreateMutex_icall",
        ves_icall_System_Threading_Mutex_CreateMutex_icall,
        gpointer,
        4,
        (MonoBoolean, const_gunichar2_ptr, gint32, MonoBoolean_ref))
HANDLES(MUTEX_2,
        "OpenMutex_icall",
        ves_icall_System_Threading_Mutex_OpenMutex_icall,
        gpointer,
        4,
...
HANDLES(NATIVEC_2,
        "CreateEvent_icall",
        ves_icall_System_Threading_Events_CreateEvent_icall,
        gpointer,
        5,
...
HANDLES(THREAD_1,
        ...
        void,
        2,
        (MonoInternalThread, MonoObject))
HANDLES(
    THREAD_1a, "ByteArrayToCurrentDomain(byte[])", ves_icall_System_Threading_Thread_ByteArrayToCurrentDomain, MonoArray, 1, (MonoArray))
...
HANDLES(
    THREAD_11, "GetState(System.Threading.InternalThread)", ves_icall_System_Threading_Thread_GetState, guint32, 1, (MonoInternalThread))
...
HANDLES(
    THREAD_18, "SetName_icall", ves_icall_System_Threading_Thread_SetName_icall, void, 3, (MonoInternalThread, const_gunichar2_ptr, gint32))
...
HANDLES(THREADP_2,
        ...
        ves_icall_System_Threading_ThreadPool_GetAvailableThreadsNative,
        void,
        2,
        (gint32_ref, gint32_ref))
...
HANDLES(
    WAITH_2, "Wait_internal", ves_icall_System_Threading_WaitHandle_Wait_internal, gint32, 4, (gpointer_ptr, gint32, MonoBoolean, gint32))
...
HANDLES(TYPEDR_1,
        ...
        ves_icall_System_TypedReference_InternalMakeTypedReference,
        void,
        4,
...
HANDLES_REUSE_WRAPPER(
    WEBIC_1, "GetMachineConfigPath", ves_icall_System_Configuration_DefaultConfig_get_machine_config_path, MonoString, 0, ())
HANDLES(WEBIC_2, "GetMachineInstallDirectory", ves_icall_System_Web_Util_ICalls_get_machine_install_dir, MonoString, 0, ())
HANDLES(
    WEBIC_3, "GetUnmanagedResourcesPtr", ves_icall_get_resources_ptr, MonoBoolean, 3, (MonoReflectionAssembly, gpointer_ref, gint32_ref))
...
HANDLES(COMOBJ_2,
        ...
        gpointer,
        3,
        (MonoComObject, MonoReflectionType, MonoBoolean))
