...
MONO_API MonoImage* mono_image_open(const char* fname, MonoImageOpenStatus* status);
MONO_API MONO_RT_EXTERNAL_ONLY MonoImage* mono_image_open_full(const char* fname, MonoImageOpenStatus* status, mono_bool refonly);
MONO_API MONO_RT_EXTERNAL_ONLY MonoImage* mono_pe_file_open(const char* fname, MonoImageOpenStatus* status);
MONO_API MONO_RT_EXTERNAL_ONLY MonoImage* mono_image_open_from_data(char* data,
                                                                    uint32_t data_len,
                                                                    mono_bool need_copy,
                                                                    MonoImageOpenStatus* status);
MONO_API MONO_RT_EXTERNAL_ONLY MonoImage* mono_image_open_from_data_full(
    char* data, uint32_t data_len, mono_bool need_copy, MonoImageOpenStatus* status, mono_bool refonly);
MONO_API MONO_RT_EXTERNAL_ONLY MonoImage* mono_image_open_from_data_with_name(
    char* data, uint32_t data_len, mono_bool need_copy, MonoImageOpenStatus* status, mono_bool refonly, const char* name);
MONO_API void mono_image_fixup_vtable(MonoImage* image);
MONO_API MONO_RT_EXTERNAL_ONLY MonoImage* mono_image_loaded(const char* name);
MONO_API MONO_RT_EXTERNAL_ONLY MonoImage* mono_image_loaded_full(const char* name, mono_bool refonly);
MONO_API MONO_RT_EXTERNAL_ONLY MonoImage* mono_image_loaded_by_guid(const char* guid);
MONO_API MONO_RT_EXTERNAL_ONLY MonoImage* mono_image_loaded_by_guid_full(const char* guid, mono_bool refonly);
...
MONO_API int mono_image_ensure_section(MonoImage* image, const char* section);
MONO_API int mono_image_ensure_section_idx(MonoImage* image, int section);
 ...
 */
MONO_API void* mono_image_lookup_resource(MonoImage* image, uint32_t res_id, uint32_t lang_id, mono_unichar2* name);
...
MONO_API void mono_image_add_to_name_cache(MonoImage* image, const char* nspace, const char* name, uint32_t idx);
